...
PLATFORM_ROOT_TIMEOUT_INPUT="${PLATFORM_ROOT_TIMEOUT-}"
GIT_REPO_URL_INPUT="${GIT_REPO_URL-}"
GIT_BRANCH_INPUT="${GIT_BRANCH-}"
PLATFORM_ENABLE_WEAVE_GITOPS_UI_INPUT="${PLATFORM_ENABLE_WEAVE_GITOPS_UI-}"
PLATFORM_ENABLE_SAMPLES_ECHO_MCP_INPUT="${PLATFORM_ENABLE_SAMPLES_ECHO_MCP-}"
...
PLATFORM_ROOT_TIMEOUT="${PLATFORM_ROOT_TIMEOUT_INPUT:-${PLATFORM_ROOT_TIMEOUT:-30m}}"
GIT_REPO_URL="${GIT_REPO_URL_INPUT:-${GIT_REPO_URL:-}}"
GIT_BRANCH="${GIT_BRANCH_INPUT:-${GIT_BRANCH:-main}}"
PLATFORM_ENABLE_WEAVE_GITOPS_UI="${PLATFORM_ENABLE_WEAVE_GITOPS_UI_INPUT:-${PLATFORM_ENABLE_WEAVE_GITOPS_UI:-false}}"
PLATFORM_ENABLE_SAMPLES_ECHO_MCP="${PLATFORM_ENABLE_SAMPLES_ECHO_MCP_INPUT:-${PLATFORM_ENABLE_SAMPLES_ECHO_MCP:-false}}"
TF_BIN="${TF_BIN:-tofu}"
...
TF_VAR_platform_root_timeout="${PLATFORM_ROOT_TIMEOUT}" \
...
TF_VAR_enable_weave_gitops_ui="${PLATFORM_ENABLE_WEAVE_GITOPS_UI}" \
TF_VAR_enable_samples_echo_mcp="${PLATFORM_ENABLE_SAMPLES_ECHO_MCP}" \
